...
class ModelArguments:
    ...
    n_cls_tokens: int = field(
        default=32,
        metadata={"help": "How many tokens used for text encoding."}
    )
    n_decoder_layers: int = field(default=2)
    use_decoder: Optional[bool] = field(
        default=False,
    ...
    head mlm
    """
    enable_decoder_mlm: Optional[bool] = field(
        default=False,
